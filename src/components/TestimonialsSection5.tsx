...
const testimonials = [
  {
    quote: "Щиты от Петро Мобил работают без нареканий уже третий год. Всё собрано аккуратно, документация полная — именно то, что нужно для серьёзного объекта.",
    author: "Андрей Смирнов",
    role: "Главный энергетик, АО СтройКомплекс",
    image: "",
  },
  {
    quote: "Обратились с нестандартной задачей — нужен был щит для распределённой диспетчеризации. Команда разработала решение быстро и в рамках бюджета.",
    author: "Светлана Орлова",
    role: "Технический директор, УК ГородСервис",
    image: "",
  },
]
        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-4 md:gap-5 max-w-xl text-center md:text-left">
            ...
            <h2 id="testimonial-title" className="text-3xl md:text-4xl font-bold">
              Нам доверяют промышленные объекты и управляющие компании
            </h2>
          </div>
